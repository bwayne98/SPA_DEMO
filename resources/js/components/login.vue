<template>
    ...
    <div class="flex flex-col flex-nowrap justify-center w-screen h-screen items-center bg-gray-100">
        <div class="text-center" v-if="register">
            <h1 class="text-xl m-5 font-light"> {{ register }} is now registed, Please Login ! </h1>
        ...
        <div id="login" class="w-96 shadow rounded-xl text-center p-5 pb-0">
            ...
            <div class="p-5 px-12">
                <form action="" v-on:submit.prevent>
                    ...
                    <div class="p-3 pb-0">
                        <button @click="getLogin()" class=" bg-blue-300 mt-2 px-2 py-1 rounded-xl hover:bg-blue-200">Submit</button>
                        <router-link to="/newuser" class="mx-2 hover:text-pink-400"> Register </router-link>
                    </div>
